...
export const BoxFreq = ({
  ...
  useEffect(() => {
    ...
    if (!readOnce.current) {
      ...
      console.log(meteroptionExponent);
      ...
      console.log(optionExponent);
    } else {
      const { split, fieldX, freq } = setting;
      let dx = fieldX / split;
  ...
  return (
    <Box>
      ...
      <FrontBody style={{ overflow: "visible" }}>
        <ColumnLayout>
          <GridColumn>
            <InputItemGrid>
            </InputItemGrid>
            <InputItemGrid>
              <JustFlexRow >
                <SmallLabel style={{marginTop:"1px"}}>周波数 [ {dispFreqUnit(HzExponent)} ] : </SmallLabel>
                <InputText
                  key={'freq'}
                  maxLength="12"
                  type="text"
            ...
            <JustFlexRow2>
              ...
              <FreeSpaceTextWrapper><FreeSpaceText style={{fontSize:"13px",marginTop:"2px"}}>自由空間波長 [ {dispMeterUnit(meterExponent)} ] : </FreeSpaceText><FreeSpaceText style={{ fontSize: "16px", minWidth: "50px", textAlign: "right", paddingRight: "5px", paddingLeft: "10px" }}>{strMeterExponent}</FreeSpaceText></FreeSpaceTextWrapper>
              <Select
              ...
              />
              <FreeSpaceTextWrapper style={{ paddingLeft: "15px" }}><FreeSpaceText style={{fontSize:"13px",marginTop:"2px"}}>空間離散間隔 [λ/格子幅] : </FreeSpaceText><FreeSpaceText style={{ fontSize: "18px", minWidth: "20px", textAlign: "right", paddingRight: "10px", paddingLeft: "5px" }}>{lambdaperDx}</FreeSpaceText></FreeSpaceTextWrapper>
